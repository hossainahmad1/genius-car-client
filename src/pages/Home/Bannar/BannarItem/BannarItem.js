...
const BannarItem = ({slide}) => {
    ...
    return (
        <div id={`slide${id}`} className="carousel-item relative w-full">
                ...
                <div className="absolute flex justify-start transform -translate-y-1/2 w-1/2 left-5 top-1/2 ">
                ...
                <div className="absolute flex justify-start transform -translate-y-1/2 w-1/2 left-5 top-3/4 ">
